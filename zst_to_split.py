...
def extract_lines(zst_file_path, total_games):
        ...
        with dctx.stream_reader(zst_file) as reader:
            for line in io.TextIOWrapper(reader, encoding='utf-8'):
                    ...
                    if found:
                        ...
                        output_file_path = '{}/rating_split/group_{}.pgn'.format(asset_folder, group)
    ...
    print("Annotated Percentage is {}".format(annotated_games_count/total_games))
